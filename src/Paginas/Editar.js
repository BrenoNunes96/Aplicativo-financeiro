...
import { adicionarDespesa, editarDespesa } from '../Data/Data';
...
export default function Formulario({ dados, pagina, buttonName }) {
  ...
  const [categoria, setCategoria] = useState(dados?.categoria || 'compras');
    ...
    <View style={styles.container}>
      ...
      <TouchableOpacity onPress={enviarFormulario} style={styles.botao2}>
        <Text style={styles.botaoTexto}>
          {pagina === 'Editar' ? 'Salvar Alterações' : 'Editar Despesa'}
        </Text>
      </TouchableOpacity>
